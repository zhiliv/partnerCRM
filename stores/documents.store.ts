...
export const useStoreDocuments = defineStore('documents', () => {
  ...
  const record = ref<FieldsDocument>({
    id: null,
    name: null,
    created_date: null
  }) // Запись
  const filter = ref<FieldsDocument | any>({})
  ...
  */
  const getList = async (): Promise<boolean> => {
    ...
    // await getCount()
    const url: string = `/api/documents/all` // Ссылка для получения данных
    try {
  ...
  */
  const getCount = async (): Promise<boolean> => {
    ...
    // await getCount()
    const url: string = `/api/documents/count` // Ссылка для получения количества записей
    try {
  ...
  */
  const create = async (): Promise<boolean> => {
    const url: string = `/api/documents/add` // Ссылка 
    try {
  ...
  */
  const get = async (): Promise<boolean> => {
    ...
    const url: string = `/api/documents/get` // Ссылка
    try {
  ...
  */
  const update = async (): Promise<boolean> => {
    const url: string = `/api/documents/update` // Ссылка
    try {
  ...
  */
  const del = async (): Promise<boolean> => {
    const url: string = `/api/documents/del` // Ссылка
    try {
